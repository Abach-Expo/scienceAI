  ...
  const plans = [
    {
      ...
      premium: false,
      features: [
        { text: '15 эссе + 5 рефератов + 2 курсовых/мес', included: true },
        { text: '15 презентаций/мес', included: true },
        { text: '20 AI-анализов', included: true },
        { text: '10 генераций диссертаций', included: true },
        { text: '3 AI изображения', included: true },
    ...
    },
    {
      ...
      premium: false,
      features: [
        { text: '30 эссе + 12 рефератов + 5 курсовых/мес', included: true },
        { text: '30 презентаций/мес', included: true },
        { text: '50 AI-анализов', included: true },
        { text: '40 генераций диссертаций', included: true },
        { text: '1 полная диссертация до 150 стр.', included: true },
        { text: '10 AI изображений', included: true },
        { text: 'Безлимитный AI-чат', included: true },
        { text: 'Anti-AI Detection + антиплагиат', included: true },
    ...
    },
    {
      ...
      premium: true,
      features: [
        { text: '60 эссе + 25 рефератов + 10 курсовых/мес', included: true },
        { text: '60 презентаций/мес', included: true },
        { text: '100 AI-анализов', included: true },
        { text: '100 генераций диссертаций', included: true },
        { text: '3 полных диссертации до 300 стр.', included: true },
        { text: '25 AI изображений', included: true },
        { text: 'Безлимитный AI-чат', included: true },
        { text: 'Anti-AI Detection v3 + антиплагиат', included: true },
        { text: 'Приоритетная поддержка', included: true },
      ],
